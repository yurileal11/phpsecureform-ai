    ...
    public static function generate(array $params, array $files): array {
        ...
        foreach ($params as $name => $meta) {
            ...
            if ($type === 'string') {
                ...
                $mutations[] = [
                    ...
                    'param'=>$name,
                    'mutation'=>'long',
                    'value'=>str_repeat('A', 2048)
                ];
                $mutations[] = [
                    'type'=>'param',
                    'param'=>$name,
                    'mutation'=>'special_chars',
                ...
                $mutations[] = [
                    'type'=>'param',
                    'param'=>$name,
                    'mutation'=>'array_length',
                    'value'=>array_fill(0,10,'x')
                    ];
            }
        }
        ...
        foreach ($files as $f) {
            ...
            $mutations[] = [
                'type'=>'file',
                'field'=>$field,
                'mutation'=>'content_type_mismatch',
                'filename'=>'sample.png',
            ...
            $mutations[] = [
                ...
                'note'=>'Simulate >5MB test; actual upload requires user consent and isolated environment.'
                ];
        }
